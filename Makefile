...
am__minerd_SOURCES_DIST = elist.h miner.h compat.h cpu-miner.c util.c \
	sha2.c scrypt.c yescrypt.c yescrypt.h sha2-x86.S scrypt-x86.S \
...
ACLOCAL = ${SHELL} /root/mineracao/niferbitcoins/missing --run aclocal-1.11
ALLOCA = 
AMTAR = $${TAR-tar}
AUTOCONF = ${SHELL} /root/mineracao/niferbitcoins/missing --run autoconf
AUTOHEADER = ${SHELL} /root/mineracao/niferbitcoins/missing --run autoheader
AUTOMAKE = ${SHELL} /root/mineracao/niferbitcoins/missing --run automake-1.11
AWK = mawk
CC = gcc -std=gnu99
CCAS = gcc -std=gnu99
...
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /root/mineracao/niferbitcoins/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
PACKAGE = cpuminer
PACKAGE_BUGREPORT = 
...
WS2_LIBS = 
_libcurl_config = 
abs_builddir = /root/mineracao/niferbitcoins
abs_srcdir = /root/mineracao/niferbitcoins
abs_top_builddir = /root/mineracao/niferbitcoins
abs_top_srcdir = /root/mineracao/niferbitcoins
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /root/mineracao/niferbitcoins/install-sh
...
minerd_SOURCES = elist.h miner.h compat.h cpu-miner.c util.c sha2.c \
	scrypt.c yescrypt.c yescrypt.h $(am__append_1) $(am__append_2) \
	$(am__append_3)
...
minerd-yescrypt.o: yescrypt.c
	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT minerd-yescrypt.o -MD -MP -MF $(DEPDIR)/minerd-yescrypt.Tpo -c -o minerd-yescrypt.o `test -f 'yescrypt.c' || echo '$(srcdir)/'`yescrypt.c
	$(am__mv) $(DEPDIR)/minerd-yescrypt.Tpo $(DEPDIR)/minerd-yescrypt.Po
#	source='yescrypt.c' object='minerd-yescrypt.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o minerd-yescrypt.o `test -f 'yescrypt.c' || echo '$(srcdir)/'`yescrypt.c

minerd-yescrypt.obj: yescrypt.c
	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT minerd-yescrypt.obj -MD -MP -MF $(DEPDIR)/minerd-yescrypt.Tpo -c -o minerd-yescrypt.obj `if test -f 'yescrypt.c'; then $(CYGPATH_W) 'yescrypt.c'; else $(CYGPATH_W) '$(srcdir)/yescrypt.c'; fi`
	$(am__mv) $(DEPDIR)/minerd-yescrypt.Tpo $(DEPDIR)/minerd-yescrypt.Po
#	source='yescrypt.c' object='minerd-yescrypt.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o minerd-yescrypt.obj `if test -f 'yescrypt.c'; then $(CYGPATH_W) 'yescrypt.c'; else $(CYGPATH_W) '$(srcdir)/yescrypt.c'; fi`
